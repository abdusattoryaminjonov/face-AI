...
for f in files_path:
    ...
    haar_cascade = cv2.CascadeClassifier('example_page/haarcascade_frontalface_default.xml')
    ...
    for (x, y, w, h) in faces_rect:
        ...
        target_path = os.path.join(target_directory,f"abdusattor_face_{count+1}.jpg")
        count = count+1
